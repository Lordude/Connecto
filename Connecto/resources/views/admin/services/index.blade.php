                ...
                <tbody>
                    @foreach ($services as $service)
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-warning"><a class="btn btn-link yellowButton" href="{{route('admin.services.edit', ['service' => $service]) }}">Modifier </a></button> </td>
                            <td><form method="POST" action="{{ route('admin.services.destroy', ['service' => $service]) }}">
                                @csrf
                                @method('DELETE')

                                <input type="submit" value="Supprimer" class="btn btn-danger text-white" onclick="return confirm('Are you sure?')" />
                              </form></td>
